#!/usr/bin/env python3
"""
Create a realistic analysis result with better content for tweet generation.
"""
...
def create_realistic_analysis():
    """Create a realistic analysis result with engaging content."""
    ...
    realistic_analysis = {
        ...
        "data": {
            ...
            **📊 On-Chain Insights:**
            ...
            "screenshots": [
                "screenshots/full_page_20250918_100000.png",
    ...
    print(f"✅ Realistic analysis created: {filepath}")
    print(f"📊 Analysis contains:")
    print(f"   - Response text: {len(realistic_analysis['data']['response_text'])} characters")
    print(f"   - Analysis type: {realistic_analysis['data']['response_metadata']['analysis_type']}")
    print(f"   - Artifacts: {len(realistic_analysis['data']['artifacts'])}")
    print(f"   - Screenshots: {len(realistic_analysis['data']['screenshots'])}")
    
    return str(filepath)

if __name__ == "__main__":
    create_realistic_analysis()
